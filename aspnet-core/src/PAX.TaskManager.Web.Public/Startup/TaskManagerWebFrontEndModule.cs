...
namespace PAX.TaskManager.Web.Public.Startup
{
    [DependsOn(
        typeof(TaskManagerWebCoreModule)
    )]
    public class TaskManagerWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TaskManagerWebFrontEndModule(IWebHostEnvironment env, TaskManagerEntityFrameworkCoreModule taskManagerEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TaskManagerWebFrontEndModule).GetAssembly());
        }
    }
}
