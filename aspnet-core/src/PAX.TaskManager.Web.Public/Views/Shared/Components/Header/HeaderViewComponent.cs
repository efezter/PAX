...
using PAX.TaskManager.Web.Public.Startup;
using PAX.TaskManager.Web.Session;

namespace PAX.TaskManager.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : TaskManagerViewComponent
    {
