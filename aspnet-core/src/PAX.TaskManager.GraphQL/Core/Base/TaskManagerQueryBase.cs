...
namespace PAX.TaskManager.Core.Base
{
    public abstract class TaskManagerQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected TaskManagerQueryBase(string fieldName,
