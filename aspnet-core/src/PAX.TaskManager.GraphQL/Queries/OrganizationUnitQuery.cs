...
using PAX.TaskManager.Core.Base;
using PAX.TaskManager.Core.Extensions;
using PAX.TaskManager.Dto;
using PAX.TaskManager.Types;

namespace PAX.TaskManager.Queries
{
    public class OrganizationUnitQuery : TaskManagerQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
