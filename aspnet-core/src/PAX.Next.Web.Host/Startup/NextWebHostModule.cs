...
using PAX.Next.Web.Startup.ExternalLoginInfoProviders;
...
namespace PAX.Next.Web.Startup
{
    ...
    public class NextWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public NextWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NextWebHostModule).GetAssembly());
        }
