...
using PAX.TaskManager.Authorization.Ldap;
...
using PAX.TaskManager.DashboardCustomization.Definitions;
using PAX.TaskManager.Debugging;
using PAX.TaskManager.DynamicEntityProperties;
using PAX.TaskManager.Features;
using PAX.TaskManager.Friendships;
using PAX.TaskManager.Friendships.Cache;
using PAX.TaskManager.Localization;
using PAX.TaskManager.MultiTenancy;
using PAX.TaskManager.Net.Emailing;
using PAX.TaskManager.Notifications;
using PAX.TaskManager.WebHooks;
using Newtonsoft.Json;

namespace PAX.TaskManager
{
    [DependsOn(
        typeof(TaskManagerCoreSharedModule),
    ...
    public class TaskManagerCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            TaskManagerLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, TaskManagerMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<TaskManagerSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
