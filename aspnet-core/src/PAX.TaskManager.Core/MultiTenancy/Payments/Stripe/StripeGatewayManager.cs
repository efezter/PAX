...
{
    public class StripeGatewayManager : TaskManagerServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "TaskManager";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TaskManagerConsts.Currency;
        }
