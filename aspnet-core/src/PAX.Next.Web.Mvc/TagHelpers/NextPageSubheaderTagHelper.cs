...
using PAX.Next.UiCustomization.Dto;

namespace PAX.Next.Web.TagHelpers
{
    ...
    public class NextPageSubheaderTagHelper : TagHelper
    {
        ...
        public NextPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
