...
using PAX.Next.Configuration.Tenants;
using PAX.Next.MultiTenancy;
using PAX.Next.Timing;
using PAX.Next.Timing.Dto;
using PAX.Next.Web.Areas.Admin.Models.Settings;
...
namespace PAX.Next.Web.Areas.Admin.Controllers
{
    ...
    public class SettingsController : NextControllerBase
    {
