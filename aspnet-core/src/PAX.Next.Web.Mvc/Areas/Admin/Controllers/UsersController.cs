...
using PAX.Next.Authorization.Permissions;
...
using PAX.Next.Web.Areas.Admin.Models.Roles;
using PAX.Next.Web.Areas.Admin.Models.Users;
...
namespace PAX.Next.Web.Areas.Admin.Controllers
{
    [Area("Admin")]
    [AbpMvcAuthorize]
    public class UsersController : NextControllerBase
    {
