...
namespace PAX.Next.Web.Areas.Admin.Views.Shared.Themes.Theme5.Components.AdminTheme5Footer
{
    public class AdminTheme5FooterViewComponent : NextViewComponent
    {
