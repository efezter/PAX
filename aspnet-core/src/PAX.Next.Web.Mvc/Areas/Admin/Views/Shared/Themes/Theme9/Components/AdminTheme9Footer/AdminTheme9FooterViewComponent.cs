...
namespace PAX.Next.Web.Areas.Admin.Views.Shared.Themes.Theme9.Components.AdminTheme9Footer
{
    public class AdminTheme9FooterViewComponent : NextViewComponent
    {
