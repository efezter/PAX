...
namespace PAX.Next.Web.Areas.Admin.Views.Shared.Themes.Theme2.Components.AdminTheme2Footer
{
    public class AdminTheme2FooterViewComponent : NextViewComponent
    {
