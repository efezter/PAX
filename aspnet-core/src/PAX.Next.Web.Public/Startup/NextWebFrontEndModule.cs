...
namespace PAX.Next.Web.Public.Startup
{
    [DependsOn(
        typeof(NextWebCoreModule)
    )]
    public class NextWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public NextWebFrontEndModule(IWebHostEnvironment env, NextEntityFrameworkCoreModule nextEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NextWebFrontEndModule).GetAssembly());
        }
    }
}
