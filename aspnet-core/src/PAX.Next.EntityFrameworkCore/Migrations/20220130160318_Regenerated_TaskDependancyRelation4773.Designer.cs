...
namespace PAX.Next.Migrations
{
    ...
    [Migration("20220130160318_Regenerated_TaskDependancyRelation4773")]
    partial class Regenerated_TaskDependancyRelation4773
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PAX.Next.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PAX.Next.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.Label", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.PaxTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.PaxTaskAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PaxTaskAttachments");
                });

            modelBuilder.Entity("PAX.Next.TaskManager.Severity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.TaskLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.Watcher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PAX.Next.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PAX.Next.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.Comment", b =>
                {
                    ...
                    b.HasOne("PAX.Next.Authorization.Users.User", "UserFk")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.PaxTask", b =>
                {
                    b.HasOne("PAX.Next.Authorization.Users.User", "AssigneeFk")
                        .WithMany()
                        .HasForeignKey("AssigneeId");

                    b.HasOne("PAX.Next.Authorization.Users.User", "ReporterFk")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PAX.Next.TaskManager.Severity", "SeverityFk")
                        .WithMany()
                        .HasForeignKey("SeverityId");

                    b.HasOne("PAX.Next.TaskManager.TaskStatus", "TaskStatusFk")
                        .WithMany()
                    ...
                    b.Navigation("ReporterFk");

                    b.Navigation("SeverityFk");
            ...
            modelBuilder.Entity("PAX.Next.TaskManager.TaskLabel", b =>
                {
                    b.HasOne("PAX.Next.TaskManager.Label", "LabelFk")
                        .WithMany()
