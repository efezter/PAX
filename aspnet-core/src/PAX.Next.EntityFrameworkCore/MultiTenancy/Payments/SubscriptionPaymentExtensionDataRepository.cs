...
using PAX.Next.EntityFrameworkCore.Repositories;

namespace PAX.Next.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : NextRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<NextDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
