...
{
    public class SubscriptionPaymentRepository : NextRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<NextDbContext> dbContextProvider)
