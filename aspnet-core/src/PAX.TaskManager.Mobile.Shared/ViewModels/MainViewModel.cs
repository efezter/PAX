...
using PAX.TaskManager.Controls;
using PAX.TaskManager.Dto;
using PAX.TaskManager.Extensions;
using PAX.TaskManager.Localization;
using PAX.TaskManager.UI;
using PAX.TaskManager.UI.Assets;
using PAX.TaskManager.Views;
using DependencyResolver = PAX.TaskManager.Core.Dependency.DependencyResolver;
...
namespace PAX.TaskManager.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "TaskManager";
