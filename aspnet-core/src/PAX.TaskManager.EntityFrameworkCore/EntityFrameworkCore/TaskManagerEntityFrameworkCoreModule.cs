...
namespace PAX.TaskManager.EntityFrameworkCore
{
    ...
    public class TaskManagerEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            // Configuration.EntityHistory.Selectors.Add("TaskManagerEntities", EntityHistoryHelper.TrackedTypes);
            // Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(TaskManagerEntityFrameworkCoreModule).GetAssembly());
        }
