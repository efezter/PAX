...
using PAX.TaskManager.EntityFrameworkCore.Repositories;

namespace PAX.TaskManager.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : TaskManagerRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<TaskManagerDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
