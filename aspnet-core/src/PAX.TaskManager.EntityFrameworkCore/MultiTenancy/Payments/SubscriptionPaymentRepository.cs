...
{
    public class SubscriptionPaymentRepository : TaskManagerRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<TaskManagerDbContext> dbContextProvider)
