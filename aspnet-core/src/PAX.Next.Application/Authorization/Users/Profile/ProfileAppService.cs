...
using PAX.Next.Authorization.Users.Profile.Cache;
...
using PAX.Next.Timing;

namespace PAX.Next.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : NextAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PAX.Next",
