...
using PAX.Next.UiCustomization;
...
{
    public class SessionAppService : NextAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = NextConsts.Currency,
                        CurrencySign = NextConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = NextConsts.AllowTenantsToChangeEmailSettings,
