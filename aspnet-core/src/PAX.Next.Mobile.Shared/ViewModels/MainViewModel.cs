...
using PAX.Next.Services.Navigation;
...
using PAX.Next.Controls;
using PAX.Next.Dto;
using PAX.Next.Extensions;
using PAX.Next.Localization;
using PAX.Next.UI;
using PAX.Next.UI.Assets;
using PAX.Next.Views;
using DependencyResolver = PAX.Next.Core.Dependency.DependencyResolver;
...
namespace PAX.Next.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Next";
