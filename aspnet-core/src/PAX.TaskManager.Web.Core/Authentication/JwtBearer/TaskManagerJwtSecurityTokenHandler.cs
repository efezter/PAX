...
namespace PAX.TaskManager.Web.Authentication.JwtBearer
{
    public class TaskManagerJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public TaskManagerJwtSecurityTokenHandler()
        {
