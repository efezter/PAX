...
using PAX.TaskManager.Authentication.TwoFactor;
using PAX.TaskManager.Authentication.TwoFactor.Google;
using PAX.TaskManager.Authorization;
using PAX.TaskManager.Authorization.Accounts.Dto;
using PAX.TaskManager.Authorization.Users;
using PAX.TaskManager.MultiTenancy;
using PAX.TaskManager.Web.Authentication.JwtBearer;
using PAX.TaskManager.Web.Authentication.TwoFactor;
using PAX.TaskManager.Web.Models.TokenAuth;
using PAX.TaskManager.Authorization.Impersonation;
using PAX.TaskManager.Authorization.Roles;
using PAX.TaskManager.Configuration;
using PAX.TaskManager.Identity;
using PAX.TaskManager.Net.Sms;
using PAX.TaskManager.Notifications;
using PAX.TaskManager.Security.Recaptcha;
using PAX.TaskManager.Web.Authentication.External;
...
namespace PAX.TaskManager.Web.Controllers
{
    ...
    public class TokenAuthController : TaskManagerControllerBase
    {
