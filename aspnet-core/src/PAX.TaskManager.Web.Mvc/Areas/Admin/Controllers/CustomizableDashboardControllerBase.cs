...
using PAX.TaskManager.Web.Areas.Admin.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : TaskManagerControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            ...
            return PartialView(
                "~/Areas/Admin/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml", viewModel);
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            var dashboardDefinition = DashboardCustomizationAppService.GetDashboardDefinition(
                ...
                {
                    DashboardName = dashboardName,
                    Application = TaskManagerDashboardCustomizationConsts.Applications.Mvc
                }
            );
