...
using PAX.TaskManager.Web.Areas.Admin.Models.Languages;
...
namespace PAX.TaskManager.Web.Areas.Admin.Controllers
{
    ...
    public class LanguagesController : TaskManagerControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = TaskManagerConsts.LocalizationSourceName;
            }
