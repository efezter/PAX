...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Theme10.Components.AdminTheme10Brand
{
    public class AdminTheme10BrandViewComponent : TaskManagerViewComponent
    {
