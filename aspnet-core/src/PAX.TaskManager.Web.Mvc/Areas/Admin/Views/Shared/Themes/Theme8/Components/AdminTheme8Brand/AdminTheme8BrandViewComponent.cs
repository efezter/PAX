...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Theme8.Components.AdminTheme8Brand
{
    public class AdminTheme8BrandViewComponent : TaskManagerViewComponent
    {
