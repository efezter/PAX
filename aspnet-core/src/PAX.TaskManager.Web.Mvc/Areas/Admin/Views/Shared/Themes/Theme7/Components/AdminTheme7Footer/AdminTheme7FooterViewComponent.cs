...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Theme7.Components.AdminTheme7Footer
{
    public class AdminTheme7FooterViewComponent : TaskManagerViewComponent
    {
