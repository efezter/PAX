...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Theme4.Components.AdminTheme4Brand
{
    public class AdminTheme4BrandViewComponent : TaskManagerViewComponent
    {
