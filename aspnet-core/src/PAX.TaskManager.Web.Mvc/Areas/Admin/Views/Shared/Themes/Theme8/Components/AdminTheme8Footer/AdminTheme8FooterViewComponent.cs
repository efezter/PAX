...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Theme8.Components.AdminTheme8Footer
{
    public class AdminTheme8FooterViewComponent : TaskManagerViewComponent
    {
