...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Default.Components.AdminDefaultFooter
{
    public class AdminDefaultFooterViewComponent : TaskManagerViewComponent
    {
