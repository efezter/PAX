...
namespace PAX.TaskManager.Web.Areas.Admin.Views.Shared.Themes.Theme3.Components.AdminTheme3Footer
{
    public class AdminTheme3FooterViewComponent : TaskManagerViewComponent
    {
