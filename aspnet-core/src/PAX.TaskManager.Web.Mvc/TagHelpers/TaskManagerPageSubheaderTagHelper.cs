...
using PAX.TaskManager.UiCustomization;
using PAX.TaskManager.UiCustomization.Dto;

namespace PAX.TaskManager.Web.TagHelpers
{
    ...
    public class TaskManagerPageSubheaderTagHelper : TagHelper
    {
        ...
        public TaskManagerPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
