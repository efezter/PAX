(function () {
    app.widgets.Widgets_Host_IncomeStatistics = function () {
        ...
        var _widget;
        var _$incomeStatisticsDatePeriod;
        ...
        this.init = function (widgetManager) {
            ...
            _$incomeStatisticsDatePeriod = _widget.find("input[name='IncomeStatisticsDatePeriod']");
        ...
        abp.event.on('app.dashboardFilters.DateRangePicker.OnDateChange', function (dateRange) {
            if (!_widget || !dateRange || (_selectedDateRange.startDate === dateRange.startDate && _selectedDateRange.endDate === dateRange.endDate)) {
                return;
            }
