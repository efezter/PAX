...
namespace PAX.Next.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            taskLabels.CreateChildPermission(AppPermissions.Pages_TaskLabels_Delete, L("DeleteTaskLabel"));

            var labels = pages.CreateChildPermission(AppPermissions.Pages_Labels, L("Labels"));
            labels.CreateChildPermission(AppPermissions.Pages_Labels_Create, L("CreateNewLabel"));
            labels.CreateChildPermission(AppPermissions.Pages_Labels_Edit, L("EditLabel"));
            labels.CreateChildPermission(AppPermissions.Pages_Labels_Delete, L("DeleteLabel"));
            ...
            var paxTaskAttachments = pages.CreateChildPermission(AppPermissions.Pages_PaxTaskAttachments, L("PaxTaskAttachments"));
            paxTaskAttachments.CreateChildPermission(AppPermissions.Pages_PaxTaskAttachments_Create, L("CreateNewPaxTaskAttachment"));
            paxTaskAttachments.CreateChildPermission(AppPermissions.Pages_PaxTaskAttachments_Edit, L("EditPaxTaskAttachment"));
            paxTaskAttachments.CreateChildPermission(AppPermissions.Pages_PaxTaskAttachments_Delete, L("DeletePaxTaskAttachment"));
            ...
            watchers.CreateChildPermission(AppPermissions.Pages_Watchers_Delete, L("DeleteWatcher"));

            var paxTasks = pages.CreateChildPermission(AppPermissions.Pages_PaxTasks, L("PaxTasks"));
            paxTasks.CreateChildPermission(AppPermissions.Pages_PaxTasks_Create, L("CreateNewPaxTask"));
            paxTasks.CreateChildPermission(AppPermissions.Pages_PaxTasks_Edit, L("EditPaxTask"));
            paxTasks.CreateChildPermission(AppPermissions.Pages_PaxTasks_Delete, L("DeletePaxTask"));
