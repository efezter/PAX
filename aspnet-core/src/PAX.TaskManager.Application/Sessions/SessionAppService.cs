            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = TaskManagerConsts.Currency,
                        CurrencySign = TaskManagerConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = TaskManagerConsts.AllowTenantsToChangeEmailSettings,
