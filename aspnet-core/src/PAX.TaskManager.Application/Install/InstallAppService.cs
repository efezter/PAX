...
using PAX.TaskManager.Migrations.Seed;
using PAX.TaskManager.Migrations.Seed.Host;
...
namespace PAX.TaskManager.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : TaskManagerAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<TaskManagerDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{TaskManagerConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{TaskManagerConsts.ConnectionStringName}", constring);
        }
