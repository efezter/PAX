...
using PAX.TaskManager.Auditing.Exporting;
using PAX.TaskManager.Authorization;
using PAX.TaskManager.Authorization.Users;
using PAX.TaskManager.Dto;
using PAX.TaskManager.EntityHistory;
using EntityHistoryHelper = PAX.TaskManager.EntityHistory.EntityHistoryHelper;

namespace PAX.TaskManager.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : TaskManagerAppServiceBase, IAuditLogAppService
    {
