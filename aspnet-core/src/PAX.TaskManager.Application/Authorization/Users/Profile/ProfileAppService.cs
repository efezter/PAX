...
using PAX.TaskManager.Authorization.Users.Profile.Cache;
...
{
    [AbpAuthorize]
    public class ProfileAppService : TaskManagerAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PAX.TaskManager",
