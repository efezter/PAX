...
namespace PAX.TaskManager.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : TaskManagerAppServiceBase, IDashboardCustomizationAppService
    {
